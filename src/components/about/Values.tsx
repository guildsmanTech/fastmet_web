...
export default function OurValues() {
  return (
    <section className="w-full px-4 sm:px-8 md:px-12 xl:px-20 py-16 md:py-20 bg-gradient-to-r from-yellow-400 to-orange-500">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
        {values.map(({icon: Icon, title, desc}) => (
          <div
            key={title}
            className="bg-white rounded-lg p-4 flex flex-col gap-2 shadow-sm"
          >
            <div className="size-9 md:size-11 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 flex items-center justify-center shrink-0">
