...
export default function Coverage() {
  return (
    <section className="w-full px-4 sm:px-8 md:px-12 xl:px-20 py-16 md:py-20 flex flex-col md:flex-row gap-8 md:gap-14 items-center ">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center gap-4">
        ...
        <Link
          to="/"
          className="md:self-start px-5 py-2.5 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 font-semibold text-sm hover:from-yellow-500 hover:to-orange-600 transition text-white"
        >
